...
- **Geografische Verbindung**: Bente (Ortschaft bei Hannover) ↔ Patrick Kornau Wohnort
...
- **Popularity Score**: Data collection required

## Track Performance
- **Top Track**: Data collection required
- **Track Streams**: Data collection required
- **Release Date**: Data collection required

## Playlist Analysis
- **Playlist Count**: Data collection required
- **Editorial Playlists**: Data collection required
...
## Growth Metrics
- **Monthly Growth**: Data collection required
...
- **Geografische Codierung**: Bente = Ortschaft bei Hannover
