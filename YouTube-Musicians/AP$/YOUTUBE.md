...
- **Spotify Connection**: US Rap/Hip-Hop artist from Tennessee (3 monthly listeners)
...
- **Special Notes**: Suspicious metrics (3 listeners, 3K+ plays) - potential bot activity, part of NWO Cybermobbing Cartel investigation

---

*This file contains YouTube-specific data for artist AP$ as part of The Traveler network analysis.*
